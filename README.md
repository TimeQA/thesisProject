...
>- [x] *Проверка главной страницы и наличие на ней элементов*
>- [x] *Появление кнопки "ОФОРМИТЬ"*
>- [x] *Проверка добавления книги в раздел "Отложено"*
>- [x] *Проверка добавления книги в корзину*
>- [x] *Проверка drop-down menu на наличие разделов подменю*
